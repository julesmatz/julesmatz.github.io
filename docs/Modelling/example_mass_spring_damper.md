...
&= (v_1+v_2)\left( a\cos(0.99t)-b\sin(0.99t) \right) + i(v_1-v_2)\left(a\sin(0.99t)+b\cos(0.99t)\right)\\
&= \begin{pmatrix}2\\-0.2\end{pmatrix}\left( a\cos(0.99t)-b\sin(0.99t) \right) + i\begin{pmatrix}0\\1.98i\end{pmatrix}\left(a\sin(0.99t)+b\cos(0.99t)\right)\\
&= \begin{pmatrix}2\\-0.2\end{pmatrix}\left( 0.5\cos(0.99t)+0.555\sin(0.99t) \right) - \begin{pmatrix}0\\1.98\end{pmatrix}\left(0.5\sin(0.99t)-0.555\cos(0.99t)\right)
\end{align}
$$
